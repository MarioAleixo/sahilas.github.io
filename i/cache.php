...
if(!empty($_GET['t'])) {
	if($_GET['t'] == 'a') {
		...
		$width_list = array(50, 112, 150, 200);
		$height_list = array(50, 112, 150, 200);
		$quality_list = array(50, 75, 100);
	} elseif($_GET['t'] == 'm') {
		$type = 'uploads/media';
		$width_list = array(100, 200, 300, 400, 500, 600, 700, 800, 900, 1000);
		$height_list = array(00, 200, 300, 400, 500, 600, 700, 800, 900, 1000);
		$quality_list = array(50, 75, 100);
	} else {
